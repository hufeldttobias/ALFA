...
(function () {
    ...
    var STRINGS = {
        da: {
            ...
            'terms.heroLead': 'Overblik over vilkår og rammer for dit abonnement.',
            ...
            'terms.sub2': 'Din løsning er fleksibel, så du kan op- eller nedskalere, hvis behovet ændrer sig.',
            'terms.deliveryTitle': 'Levering og opsætning',
            'terms.delivery1': 'Levering planlægges i samarbejde med dig, så det passer til din indflytning.',
            'terms.delivery2': 'Vi informerer om levering, opsætning og eventuelle logistikgebyrer på forhånd.',
            'terms.paymentTitle': 'Betaling',
            'terms.payment1': 'Betaling sker månedligt for den valgte periode og pakke.',
            'terms.payment2': 'Alle priser vises inkl. moms, medmindre andet er angivet.',
            'terms.damageTitle': 'Skader og ansvar',
            'terms.damage1': 'Normal slitage er forventet og dækket.',
            'terms.damage2': 'Skader ud over almindelig brug kan medføre ekstra omkostninger.',
            'terms.cancelTitle': 'Opsigelse',
            'terms.cancel1': 'Du kan opsige abonnementet via siden “Opsig abonnement”.',
            'terms.cancel2': 'Vi koordinerer afhentning og afslutter abonnementet, når møblerne er returneret.',
        ...
        en: {
            ...
            'terms.heroLead': 'Overview of terms and framework for your subscription.',
            ...
            'terms.sub2': 'Your solution is flexible so you can scale up or down if needs change.',
            'terms.deliveryTitle': 'Delivery and assembly',
            'terms.delivery1': 'Delivery is planned together with you to fit your move-in.',
            'terms.delivery2': 'We inform you in advance about delivery, assembly and any logistics fees.',
            'terms.paymentTitle': 'Payment',
            'terms.payment1': 'Payment is monthly for the selected period and package.',
            'terms.payment2': 'All prices are shown incl. VAT unless otherwise stated.',
            'terms.damageTitle': 'Damage and liability',
            'terms.damage1': 'Normal wear and tear is expected and covered.',
            'terms.damage2': 'Damage beyond ordinary use may incur extra costs.',
            'terms.cancelTitle': 'Cancellation',
            'terms.cancel1': 'You can cancel the subscription via the “Cancel subscription” page.',
            'terms.cancel2': 'We coordinate pickup and close the subscription once furniture is returned.',
